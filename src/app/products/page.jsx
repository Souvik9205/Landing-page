  ...
  return (
    <div className="px-0 lg:px-28">
      <div className="lg:mx-28">
        <div className="flex flex-col md:flex-row py-0 md:pb-20 fade-in pb-8 sm:pb-0">
        ...
        <div className="flex flex-col md:flex-row py-0 md:py-20 fade-in pb-8 sm:pb-0">
          <div className="md:w-1/2 ">
            <Product2 />
          </div>
          <div className="md:w-1/2 w-full flex flex-col gap-4 justify-center items-center p-10">
        ...
        <div className="flex flex-col md:flex-row py-0 md:py-20 fade-in pb-8 sm:pb-0">
          <div className="md:w-1/2 w-full flex flex-col gap-4 justify-center items-center p-10">
            ...
            <p className="text-lg text-gray-800 w-full md:w-auto md:h-auto h-full text-right">
              ...
              terms and conditions on providing services/products in partnership
            </p>
          </div>
          <div className="md:w-1/2 ">
            <Product5 />
        ...
        <div className="flex flex-col md:flex-row py-0 md:py-20 fade-in pb-8 sm:pb-0">
          ...
          <div className="md:w-1/2 w-full flex flex-col gap-4 justify-center items-center p-10">
            ...
            <p className="text-lg text-gray-800 w-full md:w-auto md:h-auto h-full text-left">
              ...
              of a business. Our Lead management software help clients to track
              the whole of the sales pipeline from Lead generation to qualifying
              the lead, sending proposals, conducting demos and finally closing
              the deal
            </p>
          </div>
        </div>
